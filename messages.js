// ==============================================================
// messages.js - MENSAGENS PREMIUM 2026 (CORRIGIDO)
// Design moderno • Mais emocional • Menos repetitivo
// ==============================================================

module.exports = {

  // Data de início do relacionamento (Formato: AAAA-MM-DD)
...
Se esta mensagem chegou até você, é porque existe
algo que nunca quero deixar de dizer...

Obrigado por existir.

Você transformou dias comuns em lembranças especiais,
fez meus medos perderem a força e mostrou que amar
também é encontrar paz.

Desde que você entrou na minha vida,
meu coração encontrou o lugar onde sempre quis ficar.
...
`,
  ...
  mensagensAmor: [
    "☀️ Bom dia, meu amor. Que hoje a vida cuide de você com o mesmo carinho que você cuida do meu coração. Eu te amo. ❤️",
    "🌹 Aurora, existir ao seu lado tornou minha vida muito mais bonita. Obrigado por ser quem você é. 💖",
    "✨ Você é a primeira pessoa em quem penso ao acordar e a última antes de dormir. E sinceramente... adoro isso. ❤️",
    "💕 Seu sorriso tem um jeito único de transformar qualquer dia difícil em um dia especial.",
    "🥹 Amar você é a coisa mais fácil que meu coração já fez.",
    "🌸 Você é meu lugar favorito no mundo, mesmo quando estamos apenas conversando em silêncio.",
    "💖 Se eu pudesse voltar no tempo, escolheria você exatamente da mesma forma. Em todas as vidas.",
    "🌙 O melhor momento do meu dia sempre é aquele em que posso falar com você.",
    "❤️ Meu futuro sempre fica mais bonito quando imagino você fazendo parte dele.",
    "💞 Você me faz querer ser alguém melhor todos os dias. Obrigado por me inspirar.",
    "🌷 Algumas pessoas mudam momentos. Você mudou minha vida inteira.",
    "✨ Seu abraço é o único lugar onde todas as minhas preocupações desaparecem.",
    "💖 Não importa quanto tempo passe... sempre vou olhar para você com admiração.",
    "🥰 Você conseguiu conquistar meu coração sem precisar fazer esforço. Apenas sendo você.",
    "❤️ Meu maior privilégio é poder chamar você de meu amor.",
    "🌹 Enquanto existir um amanhã, meu coração continuará escolhendo você.",
    "💝 Você é a resposta de todas as orações que um dia fiz em silêncio.",
    "💕 Eu amo cada detalhe seu. Até aqueles que você talvez nem perceba.",
    "🌸 Você faz qualquer lugar parecer casa quando está comigo.",
    "🥹 A melhor parte dos meus dias sempre acaba tendo você.",
    "✨ Obrigado por me ensinar que o amor também pode ser leve, tranquilo e verdadeiro.",
    "❤️ Meu coração encontrou paz no momento em que encontrou você.",
    "🌷 Você é meu presente favorito da vida.",
    "💖 Se felicidade tivesse um nome, provavelmente seria Aurora.",
    "🌙 Meu coração sempre vai encontrar o caminho de volta até você.",
    "💞 Existem milhões de pessoas no mundo... e, mesmo assim, eu escolheria você todas as vezes.",
    "🌹 Você faz meus dias terem mais cor, mais sentido e muito mais amor.",
    "❤️ O tempo passa, mas meu amor por você continua crescendo sem limites.",
    "🥰 Meu maior sonho continua sendo viver uma vida inteira ao seu lado.",
    "💍 Aurora... hoje, amanhã e para sempre, você continuará sendo o amor da minha vida. ❤️"
  ],
  ...
  mensagensFilhos: [
    ...
    "🌼 Que Deus acompanhe cada passinho de vocês hoje, protegendo, guiding e enchendo o coração de alegria. Tenham um dia maravilhoso! 🙏❤️",
